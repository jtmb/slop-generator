...
If this project uses a framework with its own instruction file but your file isn't matching, check for the applicable instruction. To add framework support, reference the instruction explicitly in your plan.

## Build & Test

- Use the project's build system (Makefile, CMake, build scripts, etc.)
- Check `TECH-STACK.md` for configured tools and commands
